      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-2"></div>
            <div class="col-sm-10 pull-left-2">
              <h3><?php echo $h3_slideshow_skin; ?></h3>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $h3_slideshow_skin; ?></label>
            <div class="col-sm-10">
              <select name="slideshow_skin" class="form-control">
                <?php if ($slideshow_skin == 'v5') { ?>
				<option value="v5" selected="selected">V5</option>
                <?php } else { ?>
				<option value="v5">V5</option>
                <?php } ?>
                <?php if ($slideshow_skin == 'borderlessdark') { ?>
				<option value="borderlessdark" selected="selected">Borderlessdark</option>
                <?php } else { ?>
				<option value="borderlessdark">Borderlessdark</option>
                <?php } ?>
                <?php if ($slideshow_skin == 'borderlessdark3d') { ?>
				<option value="borderlessdark3d" selected="selected">Borderlessdark3d</option>
                <?php } else { ?>
				<option value="borderlessdark3d">Borderlessdark3d</option>
                <?php } ?>
                <?php if ($slideshow_skin == 'borderlesslight') { ?>
				<option value="borderlesslight" selected="selected">Borderlesslight</option>
                <?php } else { ?>
				<option value="borderlesslight">Borderlesslight</option>
                <?php } ?>
                <?php if ($slideshow_skin == 'borderlesslight3d') { ?>
				<option value="borderlesslight3d" selected="selected">Borderlesslight3d</option>
                <?php } else { ?>
				<option value="borderlesslight3d">Borderlesslight3d</option>
                <?php } ?>
                <?php if ($slideshow_skin == 'darkskin') { ?>
				<option value="darkskin" selected="selected">Darkskin</option>
                <?php } else { ?>
				<option value="darkskin">Darkskin</option>
                <?php } ?>
                <?php if ($slideshow_skin == 'lightskin') { ?>
				<option value="lightskin" selected="selected">Lightskin</option>
                <?php } else { ?>
				<option value="lightskin">Lightskin</option>
                <?php } ?>
                <?php if ($slideshow_skin == 'minimal') { ?>
				<option value="minimal" selected="selected">Minimal</option>
                <?php } else { ?>
				<option value="minimal">Minimal</option>
                <?php } ?>
                <?php if ($slideshow_skin == 'noskin') { ?>
				<option value="noskin" selected="selected">Noskin</option>
                <?php } else { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="nav_buttons" class="form-control">
				...
				<option value="hover" selected="selected"><?php echo $text_only_hover; ?></option>
                <?php } else { ?>
				<option value="hover"><?php echo $text_only_hover; ?></option>
                <?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="nav_bullets" class="form-control">
                ...
                <?php if ($nav_bullets == 'true') { ?>
				<option value="true" selected="selected"><?php echo $text_enabled; ?></option>
                <?php } else { ?>
				<option value="true"><?php echo $text_enabled; ?></option>
                <?php } ?>
                
                <?php if ($nav_bullets == 'false') { ?>
				<option value="false" selected="selected"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
				<option value="false"><?php echo $text_disabled; ?></option>
                <?php } ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $text_nav_play_pause; ?></label>
            <div class="col-sm-10">
              <select name="nav_play_pause" class="form-control">
                
                <?php if ($nav_play_pause == 'true') { ?>
				<option value="true" selected="selected"><?php echo $text_enabled; ?></option>
                <?php } else { ?>
				<option value="true"><?php echo $text_enabled; ?></option>
                <?php } ?>
                
                <?php if ($nav_play_pause == 'false') { ?>
				<option value="false" selected="selected"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
				<option value="false"><?php echo $text_disabled; ?></option>
                <?php } ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $text_nav_thumbs; ?></label>
            <div class="col-sm-10">
              <select name="nav_thumbs" class="form-control">
                
                <?php if ($nav_thumbs == 'hover') { ?>
				<option value="hover" selected="selected"><?php echo $text_enabled; ?></option>
                <?php } else { ?>
				<option value="hover"><?php echo $text_enabled; ?></option>
                <?php } ?>
                
                <?php if ($nav_thumbs == 'disabled') { ?>
				<option value="disabled" selected="selected"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $text_nav_circle; ?></label>
            <div class="col-sm-10">
              <select name="nav_circle" class="form-control">
                
                <?php if ($nav_circle == 'true') { ?>
				<option value="true" selected="selected"><?php echo $text_enabled; ?></option>
                <?php } else { ?>
				<option value="true"><?php echo $text_enabled; ?></option>
                <?php } ?>
                
                <?php if ($nav_circle == 'false') { ?>
				<option value="false" selected="selected"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
				<option value="false"><?php echo $text_disabled; ?></option>
                <?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="nav_timer_bar" class="form-control">
                ...
                <?php if ($nav_timer_bar == 'true') { ?>
				<option value="true" selected="selected"><?php echo $text_enabled; ?></option>
                <?php } else { ?>
				<option value="true"><?php echo $text_enabled; ?></option>
                <?php } ?>
                
                <?php if ($nav_timer_bar == 'false') { ?>
				<option value="false" selected="selected"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
				<option value="false"><?php echo $text_disabled; ?></option>
                <?php } ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $text_nav_pause_hover; ?></label>
            <div class="col-sm-10">
              <select name="nav_pause_hover" class="form-control">
                
                <?php if ($nav_pause_hover == 'true') { ?>
				<option value="true" selected="selected"><?php echo $text_enabled; ?></option>
                <?php } else { ?>
				<option value="true"><?php echo $text_enabled; ?></option>
                <?php } ?>
                
                <?php if ($nav_pause_hover == 'false') { ?>
				<option value="false" selected="selected"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
				<option value="false"><?php echo $text_disabled; ?></option>
                <?php } ?>
		...
		<div class="tab-content">
          ...
          <label><?php echo $text_slide_duration; ?></label>
       	  <input type="text" class="form-control" name="sections[<?php echo $section_row; ?>][duration]" id="duration<?php echo $section_row; ?>" value="<?php echo isset($section['duration']) ? $section['duration'] : '6000'; ?>" />
          </div> <!-- form-group ends -->
          
          
          <div class="form-group col-sm-12">
          <label><?php echo $text_slide_transition; ?></label>
        <select name="sections[<?php echo $section_row; ?>][slide_transition]" class="form-control">
        <?php foreach ($slide_transitions as $key => $slide_transition) { ?>
        <option value="<?php echo $key; ?>" 
        <?php echo ($section['slide_transition'] == $key) ? 'selected="selected"' : ''; ?>>
        <?php echo $slide_transition; ?></option>
        <?php } ?>
        </select>
          </div> <!-- form-group ends -->
        ...
        <?php } ?>
          ...
          <div class="slide-preview s<?php echo $section_row; ?>" style="background-image:url('<?php echo isset($section['thumb_image']) ? $base_url . 'image/' . $section['thumb_image'] : ''; ?>');">
		...
		<div class="layer-wrapper">
          ...
          <div class="layer-table-cell icons"><b class="pull-right"><?php echo $text_layer_sort_order; ?></b><b><?php echo $text_layer_list; ?></b></div>
          <div class="layer-table-cell slider"><b><?php echo $text_layer_in; ?></b><span class="pull-right"><b><?php echo $text_layer_out; ?></b></span></div>
          </div>
          ...
          <div class="panel panel-default ">
            ...
            <input type="hidden" name="sections[<?php echo $section_row; ?>][groups][<?php echo $group_row; ?>][type]" value="<?php echo isset($section['groups'][$group_row]['type']) ? $section['groups'][$group_row]['type'] : 'text'; ?>" />	
                ...
                <div id="language-s<?php echo $section_row; ?>-g<?php echo $group_row; ?>">
                  <ul class="nav nav-tabs" id="language<?php echo $section_row; ?>">
                    ...
                    <?php if ((float)VERSION >= 2.2) { ?><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /><?php } else { ?><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><?php } ?></a></li>
                    <?php } ?>
                  </ul>
                 </div>
               <div class="tab-content">
			...
			<?php if ($section['groups'][$group_row]['type'] == 'text' || $section['groups'][$group_row]['type'] == 'button') { ?>
              ...
              <div class="row <?php if ($section['groups'][$group_row]['type'] == 'button') { echo 'border_bottom'; } ?>">
                <div class="form-group col-sm-6">
               ...
               <div class="row">
                ...
                <?php foreach ($transitionsouts as $key => $transitionsout) { ?>
                <option value="<?php echo $key; ?>" 
                <?php echo ($section['groups'][$group_row]['transitionout'] == $key) ? 'selected="selected"' : ''; ?>>
                <?php echo $transitionsout; ?></option>
                <?php } ?>
                </select>
                </div>
...
function addSlide() {	
    ...
    html += '<input type="text" class="form-control" id="duration' + section_row + '" name="sections[' + section_row + '][duration]" value="6000" />';
	html += '</div>';
	html += '<div class="form-group col-sm-12">';
	html += '<label><?php echo $text_slide_transition; ?></label>';
	html += '<select name="sections[' + section_row + '][slide_transition]" class="form-control">';
	<?php foreach ($slide_transitions as $key => $slide_transition) { ?>
    html += '<option value="<?php echo $key; ?>"><?php echo $slide_transition; ?></option>';
    <?php } ?>
	html += '</select>';
	html += '</div>';
	html += '<div class="form-group col-sm-12">';
	...
	html += '<div class="layer-table-cell icons"><b class="pull-right"><?php echo $text_layer_sort_order; ?></b><b><?php echo $text_layer_list; ?></b></div>';
...
function addLayer(section_row, layer_type) {
	...
	html += '<input class="form-control" name="sections[' + section_row + '][groups][' + group_row + '][durationin]" id="durationin-s' + section_row + '-g' + group_row + '" value="750" />';
	html += '</div>';
	html += '</div>';
	...
	<?php foreach ($transitionsouts as $key => $transitionsout) { ?>
    html += '<option value="<?php echo $key; ?>"><?php echo $transitionsout; ?></option>';
    <?php } ?>
	html += '</select>';
	html += '</div>';
	html += '<div class="form-group col-sm-6">';
	...
	html += '<div class="form-group col-sm-6">';
	html += '<label><?php echo $text_duration; ?></label>';
	html += '<input class="form-control" name="sections[' + section_row + '][groups][' + group_row + '][durationout]" id="durationout-s' + section_row + '-g' + group_row + '" value="750" />';
	html += '</div>';
	html += '</div>';
	...
	html += '<input class="form-control" type="text" data-index="0" name="sections[' + section_row + '][groups][' + group_row + '][start]" id="start-s' + section_row + '-g' + group_row + '" value="300" />';
	html += '</div>';
	...
	html += '<input class="form-control" type="text" data-index="1" name="sections[' + section_row + '][groups][' + group_row + '][end]" id="end-s' + section_row + '-g' + group_row + '" value="' + ($('#duration' + section_row + '').val() - 300) + '" />';
	html += '</div>';
	html += '</div>';
	html += '</div>';
	html += '</div>';
	...
	if (layer_type == 'text') {
	preview_layer = '<div class="preview_single_layer s' + section_row + ' g' + group_row + ' layer-edit-s' + section_row + '-g' + group_row +'" style="top:50px;left:50px;z-index:' + sort_order + ';font-size:24px;color:#222222;padding:10px 15px 10px 15px;border-radius:3px 3px 3px 3px;" onclick="layerNavigate(' + section_row + ',' + group_row + ');">Layer Caption</div>';
	}
	
	if (layer_type == 'button') {
	preview_layer = '<div class="preview_single_layer s' + section_row + ' g' + group_row + ' layer-edit-s' + section_row + '-g' + group_row +' ls_btn ls_btn_dark" style="top:50px;z-index:' + sort_order + ';left:50px;" onclick="layerNavigate(' + section_row + ',' + group_row + ');"><span>button text</span></div>';
	}
	
	if (layer_type == 'image') {
	preview_layer = '<div class="preview_single_layer s' + section_row + ' g' + group_row + ' layer-edit-s' + section_row + '-g' + group_row +'" style="top:50px;left:50px;z-index:' + sort_order + ';" onclick="layerNavigate(' + section_row + ',' + group_row + ');"><img src="<?php echo $placeholder; ?>" /></div>';
	}
...
$('.preview_single_layer.s' + section_row + '.g' + group_row + '').draggable({
stop: function() { 
...
$('.preview_single_layer.s' + section_row + '.g' + group_row + '').css("left", $(this).val() + "px");
});
$('#top-s' + section_row + '-g' + group_row + '-l<?php echo $lang; ?>').change( function(){
$('.preview_single_layer.s' + section_row + '.g' + group_row + '').css("left", $(this).val() + "px");
});
// Change z-index testa
$('#sort_order' + section_row + group_row + '').change( function(){
$('.preview_single_layer.s' + section_row + '.g' + group_row + '').css("z-index", $(this).val());
});
$('#top-s' + section_row + '-g' + group_row + '-l<?php echo $lang; ?>').change( function(){
$('.preview_single_layer.s' + section_row + '.g' + group_row + '').css("left", $(this).val() + "px");
});
...
range: true,
min: 0,
max: $('#duration' + section_row + '').val(),
step: 1,
values: [ 300 , ($('#duration' + section_row + '').val() - 300) ],
...
var $this = $(this);
$('.preview_single_layer.s' + section_row + '.g' + group_row + '').alterClass( 'ls_*' );
...
$('.preview_single_layer.s' + section_row + '.g' + group_row).remove();
...
<?php foreach($section['groups'] as $group){ ?>
// Make layers draggable
$(".preview_single_layer.s<?php echo $section_row; ?>.g<?php echo $group_row; ?>").draggable({
    stop: function() { 
...
$('.preview_single_layer.s<?php echo $section_row; ?>.g<?php echo $group_row; ?>').css("left", $(this).val() + "px");
});
$('#top-s<?php echo $section_row; ?>-g<?php echo $group_row; ?>-l<?php echo $lang; ?>').change( function(){
$('.preview_single_layer.s<?php echo $section_row; ?>.g<?php echo $group_row; ?>').css("top", $(this).val() + "px");
});
// Change image
...
$('.preview_single_layer.s<?php echo $section_row; ?>.g<?php echo $group_row; ?>').css("z-index", $(this).val());
});
// Change font
...
range: true,
min: 0,
max: $('#duration<?php echo $section_row; ?>').val(),
step: 1,
...
var $this = $(this);
$('.preview_single_layer.s<?php echo $section_row; ?>.g<?php echo $group_row; ?>').alterClass( 'ls_*' );
...
<script type="text/javascript">
/* Transition gallery popup */
$(document).delegate('.trans_gallery_trigger', 'click', function(e) {
	e.preventDefault();
	$.ajax({
		type: 'get',
		dataType: 'html',
		success: function(data) {
			html  = '<div id="modal-trans" class="modal">';
			html += '  <div class="modal-dialog">';
			html += '    <div class="modal-content">';
			html += '      <div class="modal-header">';
			html += '        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
			html += '        <h4 class="modal-title">Slide Transitions Gallery</h4>';
			html += '      </div>';
			html += '      <div class="modal-body"><iframe src="view/javascript/layerslider_assets/trans_gallery.html" width="840" height="500" frameborder="0" allowtransparency="true"></iframe></div>';
			html += '    </div';
			html += '  </div>';
			html += '</div>';
			$('body').append(html);
...
$(document).delegate('.google_webfont_trigger', 'click', function(e) {
	e.preventDefault();
	$.ajax({
		type: 'get',
		dataType: 'html',
		success: function(data) {
			html  = '<div id="modal-fonts" class="modal">';
			html += '  <div class="modal-dialog">';
			html += '    <div class="modal-content">';
			html += '      <div class="modal-header">';
			html += '        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
			html += '        <h4 class="modal-title">How to import Google Fonts</h4>';
			html += '      </div>';
			html += '      <div class="modal-body"><iframe src="view/javascript/layerslider_assets/google_fonts.html" width="840" height="500" frameborder="0" allowtransparency="true"></iframe></div>';
			html += '    </div';
			html += '  </div>';
			html += '</div>';
			$('body').append(html);
			$('#modal-fonts').modal('show');
		}
	});
});
</script>
