...
<div class="tab-pane" id="tab-footer-social-icons">
			...
			<div class="form-group">
                <label class="col-sm-2 control-label" for="config_banner_img">رقم الجوال بالفوتر </label>
                <div class="col-sm-10">
			...
			<div class="form-group">
                <label class="col-sm-2 control-label" for="config_banner_url">البريد الالكترونى بالفوتر</label>
                <div class="col-sm-10">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea name="config_adv_1_ar" placeholder="<?php echo 'حقوق اموقع بالعربية'; ?>" rows="5" id="adv_1_ar" class="form-control"><?php echo $config_adv_1_ar; ?></textarea>
                </div>
              </div>
			  <div class="form-group">
