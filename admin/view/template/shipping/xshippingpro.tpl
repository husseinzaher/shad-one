...
var tmp='<div id="__ID__" class="tab-pane shipping">'
 ...
 var auto_complete_prod={
  ...
  var auto_complete_option={
	 'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=shipping/xshippingpro/getOption&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$(document).ready(function () {		
 ...
 function saveGeneral(data) {
   ...
   if(data) {
  		...
  		$.ajax({
			url: 'index.php?route=shipping/xshippingpro/save_general&token=<?php echo $token; ?>',
			dataType: 'json',
        	data:data,
        	type:'POST',
			success: function(json) {		
 ...
 function saveMethod() {
   ...
   if(shipping_methods.length > 0) {
  		...
  		$.ajax({
			url: 'index.php?route=shipping/xshippingpro/quick_save&token=<?php echo $token; ?>&tab_id='+method_data.tab_id,
			dataType: 'json',
 ...
 function deleteMethod(tab_id) {
   ...
   if(tab_id) {
   		showLoader();
  		$.ajax({
			url: 'index.php?route=shipping/xshippingpro/delete&token=<?php echo $token; ?>&tab_id='+tab_id,
			dataType: 'json',
        	type:'GET',
			success: function(json) {		
			  if (json['error']) {
