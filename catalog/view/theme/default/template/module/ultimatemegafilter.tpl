	...
	<div class="box-content ultimatemegafilter">
		<form id="ultimatemegafilter">
			...
			<div class="option_box" <?php if(!$price_slider) { echo 'style="display:none"';}?>>
				<div class="option_name <?php if($expanded_price) echo 'hided'; ?>"><?php echo $text_price_range?> <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
				<div class="price_slider collapsible" <?php if($expanded_price) echo 'style="display:none"'; ?>>
			...
			<?php if($ratings) { ?>					
				<?php ob_start(); ?>				
					<div class="option_box" data-seo="rating" data-type="<?php echo $display_rrating; ?>">		
						<div class="option_name <?php if($expanded_rrating){echo "hided";}?>"><?php echo $text_rating; ?> 
							<span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span>
						</div>					
						<div class="collapsible" <?php if($expanded_rrating){echo 'style="display:none"';}?>>
							<div class="pf_filter_container">
								<div class="<?php echo $scroll_class; ?>">
									<?php if($display_rrating == 'select') { ?>					
										<div>
									...
									<?php } elseif($display_rrating == 'checkbox') { ?>						<table>										
											<?php foreach($ratings as $rating) { ?>
												<tr>												
													...
													<td>													<label for="rrating_<?php echo $rating['rating']; ?>"><?php echo $rating['rating']; ?></label>			</td>											
												</tr>										
											<?php } ?>								
										</table>								
									<?php } elseif($display_rrating == 'radio') { ?>						<table>
											<?php foreach($ratings as $rating) { ?>						
												<tr>											
													<td>												
									...
									<?php } elseif($display_rrating == 'star') { ?>							<table class="ultimatemegafilter_imagetype">							<?php foreach($ratings as $rating) { ?>									<tr>											
													<td>												
			...
			<?php ob_start(); ?>
			<div class="option_box iii" >
				<div class="option_name <?php if($expanded_instock) echo 'hided'; ?>">Stock <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
				<div class="collapsible" <?php if($expanded_instock) echo 'style="display:none"'; ?>>
					<div class="pf_filter_container">
						<table>
							<tr>
			...
			<?php ob_start(); ?>
			<div class="option_box jjj" >
				<div class="option_name <?php if($stock_status_expanded) echo 'hided'; ?>">Stock Status <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
				<div class="collapsible" <?php if($stock_status_expanded) echo 'style="display:none"'; ?>>
					<div class="pf_filter_container">
						<table>
							<?php foreach($stocks_status as $stock_status){ ?>
			...
			<?php $category_count = 0; if($categories) { $category_count = 1; ?>
				<?php ob_start(); ?>
				<div class="option_box 11">
					<div class="option_name <?php if($expanded_categories){echo "hided";}?>"><?php echo $text_categories; ?> <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
					<div class="collapsible" <?php if($expanded_categories){echo 'style="display:none"';}?>>
						...
						<?php } ?>				
						<div class="pf_filter_container" <?php echo $scroll; ?> >
							<div class="<?php echo $scroll_class; ?>">
			...
			<?php $manufacturer_count = 0; if($manufacturers) { $manufacturer_count = 1; ?>
				<?php ob_start(); ?>
				<div class="option_box ihh">
					<div class="option_name <?php if($expanded_manufacturer){echo "hided";}?>"><?php echo $text_manufacturers; ?> <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
			...
			<?php $attributes = array(); if($attributes_new) { ?>
				...
				?>
				<?php ob_start(); ?>
				<div class="option_box 445 <?php if($attr_group=="0") echo "option_box"; ?>">

					<div class="option_name <?php if($attribute_value['expanded']){echo "hided";}?>"><?php echo $attribute_value['name']; ?> <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>			
			...
			<?php $option_count = 0; if($options) { $option_count = 1; ?>
				<?php foreach($options as $option) { ?>
				<?php ob_start(); ?>
				<div class="option_box selec">
					<div class="option_name <?php if($option['expanded']){echo "hided";}?>"><?php echo $option['name']; ?> <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
			...
			<?php $filter_count = 0; if($filters) { $filter_count = 1; ?>
				<?php foreach($filters as $filter) { ?>
				<?php ob_start(); ?>
				<div class="option_box uuu">
					<div class="option_name <?php if($filter['expanded']){echo "hided";}?>"><?php echo $filter['name']; ?> <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
					<?php if($filter['display'] == 'select') { ?>
					<div class="collapsible" <?php if($filter['expanded']){echo 'style="display:none"';}?>>
						<div class="pf_filter_container" <?php echo $scroll; ?>>
			...
			<?php $payment_count = 0;  if($pmethod_status) { $payment_count = 1; ?>
				<?php ob_start(); ?>
				<div class="option_box oo">
					<div class="option_name <?php if($pmethod_expanded){echo "hided";}?>">Payment Methods <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
					<?php if($pmethod_display == 'select') { ?>
					<div class="collapsible" <?php if($pmethod_expanded){echo 'style="display:none"';}?>>
			...
			<?php $shipping_count = 0; if($shipping_methods && $smethod_status) { $shipping_count = 1; ?>
				<?php ob_start(); ?>
				<div class="option_box ppp">
					<div class="option_name <?php if($smethod_expanded){echo "hided";}?>">Shipping Methods <span class="umf-inl-clear" style="display:none;">Clear</span> <span class="pf_arrow"></span></div>
					<?php if($smethod_display == 'select') { ?>
					<div class="collapsible" <?php if($smethod_expanded){echo 'style="display:none"';}?>>
