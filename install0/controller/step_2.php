...
class ControllerStep2 extends Controller {
	...
	private function validate() {
		...
		if (!array_filter(array('mysql', 'mysqli', 'pdo', 'pgsql'), 'extension_loaded')) {
			$this->error['warning'] = '! MySQL تحذير : يجب تشغيل اضافة قواعد البيانات لكي يعمل متجر أوبن كارت';
		}
		...
		if (!is_writable(DIR_SYSTEM . 'cache')) {
			$this->error['warning'] = '! cache تحذير : يجب أن يكون مجلد الكاش قابل للكتابة لكي يعمل متجر اوبن كارت';
		}

		if (!is_writable(DIR_SYSTEM . 'logs')) {
			$this->error['warning'] = '! logs تحذير : يجب أن يكون مجلد التقارير قابل للكتابة لكي يعمل متجر اوبن كارت';
		}

		if (!is_writable(DIR_SYSTEM . 'download')) {
			$this->error['warning'] = '! download تحذير : يجب أن يكون مجلد ملفات التنزيل قابل للكتابة لكي يعمل متجر اوبن كارت';
		}

		if (!is_writable(DIR_SYSTEM . 'upload')) {
			$this->error['warning'] = '! upload تحذير : يجب أن يكون مجلد ملفات التنزيل قابل للكتابة لكي يعمل متجر اوبن كارت';
		}
		...
		if (!is_writable(DIR_SYSTEM . 'modification')) {
			$this->error['warning'] = 'تحذير: يجب أن يكون مجلد التعديلات قابل للكتابة لكي يعمل متجر اوبن كارت';
		}
