...
//MaintenanceModeWarn
			...
			$data['mmode'] = $this->config->get('config_maintenance');
			$data['maintenance_on'] = $this->language->get('maintenance_on');
			$data['maintenance_on_text'] = $this->language->get('maintenance_on_text');
			$data['maintenance_disable'] = $this->language->get('maintenance_disable');
			$data['maintenance_off'] = $this->language->get('maintenance_off');
			$data['maintenance_off_text'] = $this->language->get('maintenance_off_text');
			$data['maintenance_enable'] = $this->language->get('maintenance_enable');
//MaintenanceModeWarn
