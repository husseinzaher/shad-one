  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
				...
				<!-- xml -->	
			 <li id="smssetting"><a class="parent"><i class="fa fa-comments" aria-hidden="true"></i> <span><?php echo $text_tmdsms; ?></span></a>
			    <ul>
			      <li><a href="<?php echo $tmdsmssetting; ?>"><?php echo $text_tmdsms; ?></a></li>
