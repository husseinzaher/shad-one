...
class ControllerSettingSetting extends Controller {
	...
	$query = $this->db->query("SELECT `setting_id` FROM `" . DB_PREFIX . "setting` WHERE `key` = 'config_swap_list_image' LIMIT 1");
	if (!$query->rows) {
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "image_swap` (
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`store_id`, `code`, `key`, `value`, `serialized`) VALUES
			(0, 'config', 'config_swap_additional', '1', 0),
			(0, 'config', 'config_swap_list_image', '1', 0),
			(0, 'config', 'config_swap_list_width', '24', 0),
			(0, 'config', 'config_swap_list_height', '24', 0),
			(0, 'config', 'config_swap_list_radius', '0', 0),
			(0, 'config', 'config_swap_bullet', '1', 0),
			(0, 'config', 'config_swap_bullet_image', '1', 0),
			(0, 'config', 'config_swap_bullet_width', '24', 0),
			(0, 'config', 'config_swap_bullet_height', '24', 0),
			(0, 'config', 'config_swap_bullet_radius', '0', 0);");
		header('Refresh: 0');
	}
		...
		if (isset($this->request->post['config_image'])) {
			...
			$data['config_image'] = $this->config->get('config_image');
				...
				if (isset($this->request->post['config_banner_img'])) {
					$data['config_banner_img'] = $this->request->post['config_banner_img'];
				} else {
					$data['config_banner_img'] = $this->config->get('config_banner_img');
				}
				if (isset($this->request->post['config_banner_url'])) {
					$data['config_banner_url'] = $this->request->post['config_banner_url'];
				} else {
					$data['config_banner_url'] = $this->config->get('config_banner_url');
				}
				...
				if (isset($this->request->post['config_whatsapp_id'])) {
					$data['config_whatsapp_id'] = $this->request->post['config_whatsapp_id'];
				} else {
					$data['config_whatsapp_id'] = $this->config->get('config_whatsapp_id');
				}
				...
				if (isset($this->request->post['config_snapchat'])) {
					$data['config_snapchat'] = $this->request->post['config_snapchat'];
				} else {
					$data['config_snapchat'] = $this->config->get('config_snapchat');
				}
			...
			$data['config_instagramid'] = $this->request->post['config_instagramid'];
				...
				if (isset($this->request->post['config_adv_1_ar'])) {
					$data['config_adv_1_ar'] = $this->request->post['config_adv_1_ar'];
				} else {
					$data['config_adv_1_ar'] = $this->config->get('config_adv_1_ar');
				}
				if (isset($this->request->post['config_adv_1_en'])) {
					$data['config_adv_1_en'] = $this->request->post['config_adv_1_en'];
				} else {
					$data['config_adv_1_en'] = $this->config->get('config_adv_1_en');
				}
		...
		if (isset($this->request->post['config_swap_additional'])) {
	$data['config_swap_additional'] = $this->request->post['config_swap_additional'];
} else {
	$data['config_swap_additional'] = $this->config->get('config_swap_additional');
}
if (isset($this->request->post['config_swap_list_image'])) {
	$data['config_swap_list_image'] = $this->request->post['config_swap_list_image'];
} else {
	$data['config_swap_list_image'] = $this->config->get('config_swap_list_image');
}
if (isset($this->request->post['config_swap_list_width'])) {
	$data['config_swap_list_width'] = $this->request->post['config_swap_list_width'];
} else {
	$data['config_swap_list_width'] = $this->config->get('config_swap_list_width');
}
if (isset($this->request->post['config_swap_list_height'])) {
	$data['config_swap_list_height'] = $this->request->post['config_swap_list_height'];
} else {
	$data['config_swap_list_height'] = $this->config->get('config_swap_list_height');
}
if (isset($this->request->post['config_swap_list_radius'])) {
	$data['config_swap_list_radius'] = $this->request->post['config_swap_list_radius'];
} else {
	$data['config_swap_list_radius'] = $this->config->get('config_swap_list_radius');
}
if (isset($this->request->post['config_swap_bullet'])) {
	$data['config_swap_bullet'] = $this->request->post['config_swap_bullet'];
} else {
	$data['config_swap_bullet'] = $this->config->get('config_swap_bullet');
}
if (isset($this->request->post['config_swap_bullet_image'])) {
	$data['config_swap_bullet_image'] = $this->request->post['config_swap_bullet_image'];
} else {
	$data['config_swap_bullet_image'] = $this->config->get('config_swap_bullet_image');
}
if (isset($this->request->post['config_swap_bullet_width'])) {
	$data['config_swap_bullet_width'] = $this->request->post['config_swap_bullet_width'];
} else {
	$data['config_swap_bullet_width'] = $this->config->get('config_swap_bullet_width');
}
if (isset($this->request->post['config_swap_bullet_height'])) {
	$data['config_swap_bullet_height'] = $this->request->post['config_swap_bullet_height'];
} else {
	$data['config_swap_bullet_height'] = $this->config->get('config_swap_bullet_height');
}
if (isset($this->request->post['config_swap_bullet_radius'])) {
	$data['config_swap_bullet_radius'] = $this->request->post['config_swap_bullet_radius'];
} else {
