...
<li><a href="#tab-option-image-swap" data-toggle="tab">Option Image Swap</a></li>
            <li><a href="#tab-google" data-toggle="tab"><?php echo $tab_google; ?></a></li>
			<li><a href="#tab-footer-social-icons" data-toggle="tab"><?php echo 'Additional settings'; ?></a></li>
          </ul>
...
<div class="tab-pane" id="tab-footer-social-icons">
			...
			<div class="form-group">
                <label class="col-sm-2 control-label" for="config_banner_img">رابط البنر بمنتصف الرئيسية</label>
                <div class="col-sm-10">
                  <input class="form-control" id="config_banner_img" type="text" name="config_banner_img" placeholder="" value="<?php echo $config_banner_img; ?>" />
                </div>
           </div>
			<div class="form-group">
                <label class="col-sm-2 control-label" for="config_banner_url">الربط على البنر بمنتصف الرئيسية</label>
                <div class="col-sm-10">
                  <input class="form-control" id="config_banner_url" type="text" name="config_banner_url" placeholder="" value="<?php echo $config_banner_url; ?>" />
                </div>
           </div>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="image1-id">رابط صورة الدفع بالفوتر</label>
                <div class="col-sm-10">
                  <input class="form-control" id="image1-id" type="text" name="config_image1" placeholder="" value="<?php echo $config_image1; ?>" />
                </div>
              </div>
			  
			  
			<div class="form-group">
                <label class="col-sm-2 control-label" for="confing-location-id">VAT NUMBER</label>
                <div class="col-sm-10">
                  <input class="form-control" id="confing-location-id" type="text" name="config_location_id" placeholder="Your VAT NUMBER" value="<?php echo $config_location_id; ?>" />
                </div>
              </div>
			  
			  
			<div class="form-group">
                <label class="col-sm-2 control-label" for="whatsapp-id">whatsapp number</label>
                <div class="col-sm-10">
                  <input class="form-control" id="whatsapp-id" type="text" name="config_whatsapp_id" placeholder="Your whatsapp" value="<?php echo $config_whatsapp_id; ?>" />
                </div>
              </div>
			...
			<div class="form-group">
                ...
                <div class="col-sm-10">
                  <input class="form-control" id="instagram-id" type="text" name="config_instagram" placeholder="Your instagram Page URL" value="<?php echo $config_instagram; ?>" />
                </div>
              </div>
			  
			<div class="form-group">
                <label class="col-sm-2 control-label" for="snapchat-id">snapchat URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="snapchat-id" type="text" name="config_snapchat" placeholder="Your snapchat Page URL" value="<?php echo $config_snapchat; ?>" />
                </div>
              </div>
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="linked-id">pinterest URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="linked-id" type="text" name="config_linkedid" placeholder="Your pinterest URL" value="<?php echo $config_linkedid; ?>" />
                </div>
              </div>
			  
              
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="adv_1_ar">حقوق الموقع بالعربية </label>
                <div class="col-sm-10">
                  <textarea name="config_adv_1_ar" placeholder="<?php echo 'حقوق الموقع بالعربية'; ?>" rows="5" id="adv_1_ar" class="form-control"><?php echo $config_adv_1_ar; ?></textarea>
                </div>
              </div>
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="adv_1_en">حقوق الموقع بالاجنبية </label>
                <div class="col-sm-10">
                  <textarea name="config_adv_1_en" placeholder="<?php echo 'حقوق الموقع بالاجنبية'; ?>" rows="5" id="adv_1_en" class="form-control"><?php echo $config_adv_1_en; ?></textarea>
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-option-image-swap">
	<fieldset>
		<legend>Additional Images</legend>
		<div class="form-group">
			<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Additional images shown by default on the product page.">Default Images</span></label>
			<div class="col-sm-10">
				<label class="radio-inline">
					<?php if ($config_swap_additional == 0) { ?>
					<input type="radio" name="config_swap_additional" value="0" checked="checked" />
					Standard Images
					<?php } else { ?>
					<input type="radio" name="config_swap_additional" value="0" />
					Standard Images
					<?php } ?>
				</label>
				<label class="radio-inline">
					<?php if ($config_swap_additional == 2) { ?>
					<input type="radio" name="config_swap_additional" value="2" checked="checked" />
					First Option Variation
					<?php } else { ?>
					<input type="radio" name="config_swap_additional" value="2" />
					First Option Variation
					<?php } ?>
				</label>
				<label class="radio-inline">
					<?php if ($config_swap_additional == 1) { ?>
					<input type="radio" name="config_swap_additional" value="1" checked="checked" />
					All Option Variations
					<?php } else { ?>
					<input type="radio" name="config_swap_additional" value="1" />
					All Option Variations
					<?php } ?>
				</label>
			</div>
	...
	<fieldset>
		<legend>List Type Options</legend>
		<div class="form-group">
			<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Image used for list type options.">Option Value Image</span></label>
			<div class="col-sm-10">
				<label class="radio-inline">
					<?php if ($config_swap_list_image) { ?>
					<input type="radio" name="config_swap_list_image" value="1" checked="checked" />
					Option Value Image
					<?php } else { ?>
					<input type="radio" name="config_swap_list_image" value="1" />
					Option Value Image
					<?php } ?>
				</label>
				<label class="radio-inline">
					<?php if (!$config_swap_list_image) { ?>
					<input type="radio" name="config_swap_list_image" value="0" checked="checked" />
					Product Image
					<?php } else { ?>
					<input type="radio" name="config_swap_list_image" value="0" />
					Product Image
					<?php } ?>
				</label>
			</div>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="List type option properties (Width, Height, Radius).">List Option Style</span></label>
			<div class="col-sm-3">
				<input type="text" name="config_swap_list_width" value="<?php echo $config_swap_list_width; ?>" placeholder="List type option width" class="form-control" />
			</div>
			<div class="col-sm-3">
				<input type="text" name="config_swap_list_height" value="<?php echo $config_swap_list_height; ?>" placeholder="List type option height" class="form-control" />
			</div>
			<div class="col-sm-3">
				<input type="text" name="config_swap_list_radius" value="<?php echo $config_swap_list_radius; ?>" placeholder="List type option radius" class="form-control" />
			</div>
		</div>
	</fieldset>
	<fieldset>
		<legend>Product Listing Option Bullets</legend>
		<div class="form-group">
			<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Show option bullets and enable image swapping on product listings.">Enable Bullets</span></label>
			<div class="col-sm-10">
				<label class="radio-inline">
					<?php if ($config_swap_bullet) { ?>
					<input type="radio" name="config_swap_bullet" value="1" checked="checked" />
					<?php echo $text_yes; ?>
					<?php } else { ?>
					<input type="radio" name="config_swap_bullet" value="1" />
					<?php echo $text_yes; ?>
					<?php } ?>
				</label>
				<label class="radio-inline">
					<?php if (!$config_swap_bullet) { ?>
					<input type="radio" name="config_swap_bullet" value="0" checked="checked" />
					<?php echo $text_no; ?>
					<?php } else { ?>
					<input type="radio" name="config_swap_bullet" value="0" />
					<?php echo $text_no; ?>
					<?php } ?>
				</label>
			</div>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Image used for option bullets on product listings.">Bullet Image</span></label>
			<div class="col-sm-10">
				<label class="radio-inline">
					<?php if ($config_swap_bullet_image) { ?>
					<input type="radio" name="config_swap_bullet_image" value="1" checked="checked" />
					Option Value Image
					<?php } else { ?>
					<input type="radio" name="config_swap_bullet_image" value="1" />
					Option Value Image
					<?php } ?>
				</label>
				<label class="radio-inline">
					<?php if (!$config_swap_bullet_image) { ?>
					<input type="radio" name="config_swap_bullet_image" value="0" checked="checked" />
					Product Image
					<?php } else { ?>
					<input type="radio" name="config_swap_bullet_image" value="0" />
					Product Image
					<?php } ?>
				</label>
			</div>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Option bullet properties (Width, Height, Radius).">Bullet Style:</span></label>
			<div class="col-sm-3">
				<input type="text" name="config_swap_bullet_width" value="<?php echo $config_swap_bullet_width; ?>" placeholder="Option bullet width" class="form-control" />
			</div>
			<div class="col-sm-3">
				<input type="text" name="config_swap_bullet_height" value="<?php echo $config_swap_bullet_height; ?>" placeholder="Option bullet height" class="form-control" />
			</div>
			<div class="col-sm-3">
				<input type="text" name="config_swap_bullet_radius" value="<?php echo $config_swap_bullet_radius; ?>" placeholder="Option bullet radius" class="form-control" />
			</div>
		</div>
	</fieldset>
</div>
