...
<div class="umf-product-container">
    ...
    background-color: #62c465;
      ...
      <div class="row pages">
        <div class="col-sm-6 text-left"><div class="text-left pagination_container"><div class="text-left pagination_container"><?php echo $pagination; ?></div></div></div>
        <div class="col-sm-6 text-left"><div class="text-right pagination_result"><div class="text-right pagination_result"><?php echo $results; ?></div></div></div>
      </div>
      <?php } ?>
