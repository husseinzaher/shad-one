...
-->
      ...
      <div class="row">
        ...
        <div class="col-sm-1 col-xs-3 text-right pl-0">
          <label class="control-label" for="input-sort"><?php echo $text_sort; ?></label>
        </div>
        <div class="col-sm-2 col-xs-3 text-right pr-0">
        ...
        <div class="col-sm-1 col-xs-2 text-right pl-0">
          <label class="control-label" for="input-limit"><?php echo $text_limit; ?></label>
        </div>
        <div class="col-sm-2 col-xs-4 text-right pr-0">
